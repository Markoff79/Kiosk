CREATE TABLE [DIL].[md_GLAccount] (
  ...
  , [tst] datetime2(3) CONSTRAINT [DF_DIL_md_GLAccount_tst] DEFAULT (SYSDATETIME()) NOT NULL
...
ALTER TABLE [DIL].[md_GLAccount] ADD CONSTRAINT [PK_DIL_md_GLAccount] PRIMARY KEY CLUSTERED ([ChartOfAccounts_KEY] ASC, [GLAccount_KEY] ASC) WITH (DATA_COMPRESSION = ROW);
GO
