CREATE TABLE [DAL_SAP].[td_0FI_AP_4] (
  [tst] datetime2(3) CONSTRAINT [DF_DAL_SAP_td_0FI_AP_4] DEFAULT (SYSDATETIME()) NOT NULL
...
GO
EXECUTE sp_addextendedproperty @name = N'sampleDataExport', @value = N'yes', @level0type = N'SCHEMA', @level0name = N'DAL_SAP', @level1type = N'TABLE', @level1name = N'td_0FI_AP_4';
